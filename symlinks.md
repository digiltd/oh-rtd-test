...
To get IdVendor, product, and IdProduct, you need type in the following (for USB0, USB1, ACM0 etc) "sudo udevadm info --attribute-walk --path=/sys/bus/usb-serial/devices/ttyUSB0"
