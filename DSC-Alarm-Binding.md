...
<table>
    ...
    <tr><td>partition_arm_mode</td><td>Number</td><td>A partitions current arm mode. The possible values are 0=disarmed, 1=armed away, 2=armed stay, 3=away no delay, 4=stay no delay</td></tr>
